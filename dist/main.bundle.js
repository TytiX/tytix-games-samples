...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__first_game_first_game_component__ = __webpack_require__("../../../../../src/app/first-game/first-game.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__second_game_second_game_component__ = __webpack_require__("../../../../../src/app/second-game/second-game.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__online_game_online_game_component__ = __webpack_require__("../../../../../src/app/online-game/online-game.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__first_game_first_game_component__["a" /* FirstGameComponent */],
                __WEBPACK_IMPORTED_MODULE_8__second_game_second_game_component__["a" /* SecondGameComponent */],
                __WEBPACK_IMPORTED_MODULE_9__online_game_online_game_component__["a" /* OnlineGameComponent */],
                __WEBPACK_IMPORTED_MODULE_10__chat_chat_component__["a" /* ChatComponent */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */],
                __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* RouterModule */].forRoot(__WEBPACK_IMPORTED_MODULE_4__app_router__["a" /* appRoutes */])
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_11__chat_chat_service__["a" /* ChatService */]
            ],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__online_game_online_game_component__ = __webpack_require__("../../../../../src/app/online-game/online-game.component.ts");
...
var appRoutes = [
    ...
    { path: 'online', component: __WEBPACK_IMPORTED_MODULE_3__online_game_online_game_component__["a" /* OnlineGameComponent */] },
...
module.exports = "<div *ngIf=\"name\" class=\"container\">\r\n  <div *ngFor=\"let data of messageList\" class=\"messages\">\r\n    <div>{{data.name}}</div>\r\n    <div>{{data.msg}}</div>\r\n  </div>\r\n</div>\r\n<div *ngIf=\"name\" class=\"input\">\r\n  <input #msg\r\n      (keyup.enter)=\"sendMessage(msg.value); msg.value='' \">\r\n  <button (click)=\"sendMessage(msg.value)\">SEND</button>\r\n</div>\r\n\r\n<div *ngIf=\"!name\">\r\n  <input #name\r\n      (keyup.enter)=\"setName(name.value)\">\r\n  <button (click)=\"setName(name.value)\">SET</button>\r\n</div>"
...
var ChatComponent = /** @class */ (function () {
    ...
    ChatComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.chatService.register().subscribe(function (dataMsg) {
            console.log('[ChatComponent] msg :', dataMsg);
            _this.messageList.push(dataMsg);
        });
    };
    ...
    ChatComponent.prototype.setName = function (name) {
        this.name = name;
    };
...
var ChatService = /** @class */ (function () {
    ...
    ChatService.prototype.register = function () {
        var _this = this;
        console.log('register');
        return new __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["a" /* Observable */](function (subscriber) {
            _this.messageSubscriber = subscriber;
            console.log(_this.messageSubscriber);
        });
    };
    ChatService.prototype.receivedMessage = function (data) {
    ...
    ChatService.prototype.emitMessage = function (data) {
...
/***/ "../../../../../src/app/online-game/game-engine.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GameEngine; });
...
var GameEngine = /** @class */ (function () {
    function GameEngine(network) {
        ...
        this.game = new __WEBPACK_IMPORTED_MODULE_0_phaser_ce__["Game"](800, 600, Phaser.AUTO, 'phaser-tank', this.gameState);
    }
    ...
    GameEngine.prototype.create = function () {
        ...
        this.enemyBullets.createMultiple(1000, 'bullet');
    ...
    GameEngine.prototype.removeLogo = function () {
    ...
    GameEngine.prototype.bulletHitPlayer = function (tank, bullet) {
        bullet.kill();
    };
    GameEngine.prototype.bulletHitEnemy = function (tank, bullet) {
        bullet.kill();
    ...
    GameEngine.prototype.render = function () {
        this.game.debug.text('Active Bullets: ' + this.bullets.countLiving() + ' / ' + this.bullets.length, 32, 64);
...
/***/ "../../../../../src/app/online-game/network-engine.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NetworkEngine; });
...
var NetworkEngine = /** @class */ (function () {
    ...
    NetworkEngine.prototype.newPlayerConnected = function (player) {
    };
    NetworkEngine.prototype.playerMoved = function (player) {
    };
    NetworkEngine.prototype.playeFired = function (player) {
    };
    NetworkEngine.prototype.playeRotated = function (player) {
    };
...
/***/ "../../../../../src/app/online-game/online-game.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/online-game/online-game.component.html":
/***/ (function(module, exports) {
...
/***/ "../../../../../src/app/online-game/online-game.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return OnlineGameComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__game_engine__ = __webpack_require__("../../../../../src/app/online-game/game-engine.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__network_engine__ = __webpack_require__("../../../../../src/app/online-game/network-engine.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var OnlineGameComponent = /** @class */ (function () {
    ...
    OnlineGameComponent.prototype.ngOnInit = function () {
        this.engine = new __WEBPACK_IMPORTED_MODULE_1__game_engine__["a" /* GameEngine */](new __WEBPACK_IMPORTED_MODULE_2__network_engine__["a" /* NetworkEngine */]());
    };
    OnlineGameComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-online-game',
            template: __webpack_require__("../../../../../src/app/online-game/online-game.component.html"),
            styles: [__webpack_require__("../../../../../src/app/online-game/online-game.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], OnlineGameComponent);
